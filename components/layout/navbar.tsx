...
export function Navbar() {
  ...
  const { isRegistered, isRegistering, error, publicKeyFingerprint, waitingForEncryption } = useDeviceRegistration()
          ...
          <div className="flex items-center space-x-2 sm:space-x-4">
            ...
            <div className="relative">
              <button
                ...
                title={isRegistered ? 'Device registered' : isRegistering ? 'Registering...' : waitingForEncryption ? 'Waiting for encryption...' : error ? 'Registration error' : 'Not registered'}
              >
                {isRegistered ? (
                ...
                <div className="absolute right-0 mt-2 w-64 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 z-50 p-3">
                  <div className="flex items-start gap-2">
                    {isRegistered ? (
                      ...
                      <>
                        <svg className="w-5 h-5 text-yellow-500 animate-pulse flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                          <path fillRule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clipRule="evenodd" />
                        </svg>
                        <div>
                          <p className="text-sm font-medium text-yellow-600 dark:text-yellow-400">Waiting for Encryption</p>
                          <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Please unlock encryption to complete device setup</p>
                        </div>
                      </>
                    ) : error ? (
                      <>
